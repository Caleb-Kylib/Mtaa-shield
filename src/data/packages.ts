...
export const insurancePackages: InsurancePackage[] = [
  ...
  },
  {
    ...
    occupation: 'farmer',
    tier: 'animal',
    tagline: 'Dedicated livestock & animal protection for farmers',
    weeklyPrice: 90,
    monthlyPrice: 342,
    quarterlyPrice: 972,
    ...
    features: [
      ...
      'Predator & wildlife attack',
      'Theft & rustling cover',
      'Emergency veterinary costs',
      'Drought & starvation loss',
      'Transit & handling accidents',
      'AI vet consultation alerts',
    ],
    popular: false,
    color: 'teal',
  },
